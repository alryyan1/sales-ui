...
export const navItems: NavItem[] = [
    ...
    { to: '/inventory/adjustments', label: 'تعديلات المخزون', icon: BoxIcon, permission: null },
    { to: '/sales', label: 'المبيعات', icon: CircleDollarSign, permission: null },
    { to: '/sales/pos-new', label: 'نقطة البيع', icon: CircleDollarSign, permission: null },
    { to: '/sales/returns', label: 'مرتجعات المبيعات', icon: CircleDollarSign, permission: null },
];
...
export const reportItems: NavItem[] = [
    ...
    { to: '/reports/profit-loss', label: 'تقرير الأرباح والخسائر', permission: null },
    { to: '/reports/inventory-log', label: 'سجل المخزون', permission: null },
    { to: '/reports/near-expiry', label: 'قرب انتهاء الصلاحية', permission: null },
    { to: '/reports/monthly-revenue', label: 'الإيرادات الشهرية', permission: null },
    { to: '/reports/sales-discounts', label: 'المبيعات المخفضة', permission: null },
];
...
export const adminItems: NavItem[] = [
    ...
    { to: '/admin/inventory/requisitions/request', label: 'طلب مخزون', permission: null },
    { to: '/admin/inventory/requisitions', label: 'طلبات المخزون', permission: null },
];
