...
import { Outlet, Link as RouterLink, useNavigate, useLocation, useOutletContext } from 'react-router-dom';
...
const RootLayout: React.FC = () => {
    ...
    if (isLoading && user === null) { // Avoid full screen loader on simple navigation if user is already known
        return (
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            <Container component="main" maxWidth="xl" sx={{ mt: 4, mb: 4, flexGrow: 1 }}>
                ...
                <Outlet context={{ user, isLoading, handleLoginSuccess, handleRegisterSuccess } satisfies AuthContextType} />
            </Container>
