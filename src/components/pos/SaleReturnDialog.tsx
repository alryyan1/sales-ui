    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
                                ...
                                <Table size="small">
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell align="center" width={100}>الكمية المرجعة</TableCell>
                                            <TableCell align="center" width={150}>الحالة</TableCell>
                                        ...
                                        {saleDetails.items?.map((item) => {
                                            ...
                                            return (
                                                <TableRow key={item.id} selected={isSelected}>
                                                    ...
                                                    <TableCell align="center">{formatNumber(item.unit_price)}</TableCell>
                                                    <TableCell align="center">
                                                        <TextField
                                                            type="number"
                                                            size="small"
                                                            inputProps={{ min: 1, max: selection.maxReturnable }}
                                                    ...
                                                    <TableCell align="right" sx={{ fontWeight: 'bold' }}>
                                                        {isSelected
                                                            ? formatNumber(selection.quantity * Number(item.unit_price))
                                                            : "-"}
                                                    </TableCell>
                                                </TableRow>
                                            );
                            ...
                            <Box sx={{ p: 2, bgcolor: "action.hover", borderRadius: 2 }}>
                                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3}>
                                    ...
                                    <Box sx={{ minWidth: 200, textAlign: "right" }}>
                                        <Typography variant="body2" color="text.secondary">إجمالي الإرجاع</Typography>
            ...
            <DialogActions sx={{ p: 2 }}>
                ...
                >
                    {createReturnMutation.isPending ? "جاري المعالجة..." : "تأكيد الإرجاع"}
                </Button>
            </DialogActions>
        </Dialog>
    );
