    ...
    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">
          {t("reports:purchaseReportPage.title")}
        </h1>
        <p className="text-slate-500 mt-1">
          {t("reports:purchaseReportPage.subtitle")}
        </p>
      </div>
      ...
      <div className="flex gap-2">
        ...
        >
          <FileText size={14} />
          {t("reports:purchaseReportPage.exportPdfButton")}
        </Button>
        <Button
          variant="outline"
          size="sm"
        ...
        >
          <FileText size={14} />
          {t("reports:purchaseReportPage.exportExcelButton")}
        </Button>
      </div>
    </div>
  );
